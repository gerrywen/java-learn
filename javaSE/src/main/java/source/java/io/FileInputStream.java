 ...
 * @since   JDK1.0
 *
 * 一个<code>FileInputStream</code>从文件系统中的一个文件获取输入字节。
 * 哪些文件可用取决于主机环境。
 */
public
class FileInputStream extends InputStream
{
     ...
     *
     * 创建一个<code>FileInputStream</code>通过打开到一个实际文件的连接，
     * 该文件的路径名<code>name</code> 文件系统。
     * 创建了一个新的<code>FileDescriptor</code>对象来表示这个文件连接。
     */
     ...
     *
     * 创建一个<code>FileInputStream</code>通过打开到一个实际文件的连接，
     * 该文件在文件系统中由<code>file</code> object <code>file</code> >命名。
     * 创建了一个新的<code>FileDescriptor</code>对象来表示这个文件连接。
     */
...
//                channel = FileChannelImpl.open(fd, path, true, false, this);
     ...
     *
     * 确保在没有对该文件输入流的更多引用时调用该文件输入流的<code>close</code>方法。
     */
