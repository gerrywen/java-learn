...
/**
 * program: java-learn->ClusterServiceTests
 * description:
 * author: gerry
 * created: 2020-04-11 23:40
 **/
...
public class ClusterServiceTests {
    ...
    @Test
    public void getTest() {
        System.out.println(clusterService.get("tony"));
        System.out.println(clusterService.get("a"));
        System.out.println(clusterService.get("foo"));
    }
